...
export class VerifyPage {
  ...
  getAddrress(position) {
   ...
   //add='47A Lorong 4 Geylang 399291';
    ...
    this.nativeGeocoder.forwardGeocode(this.unitno+' '+this.street+' '+this.postalcode)
      ...
      .catch((error: Error) => {
        ...
        alert("Error retriving the geo location of given address " + JSON.stringify(error));
